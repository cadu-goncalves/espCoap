...
void ICACHE_FLASH_ATTR rxd_cb(uint8_t data);

void (*uart0_rx_data_cb)(uint8_t data);

void ICACHE_FLASH_ATTR uart0_rx_setCallbacks(void (*rxd_cb)(uint8_t))
{
  uart0_rx_data_cb = rxd_cb;
}
