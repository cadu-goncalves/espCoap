...
typedef struct coap_ep_t coap_ep_t;

typedef int (*coap_endpoint_func)(struct espconn *espconn,const coap_endpoint_t *ep, coap_rw_buffer_t *scratch, const coap_packet_t *inpkt, coap_packet_t *outpkt, uint8_t id_hi, uint8_t id_lo, uint8_t obs);
